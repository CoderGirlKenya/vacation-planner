...
//allows other component functions to run 
    useEffect(() => {
      ...
      fetch("https://api.jsonbin.io/b/618071784a82881d6c68e66f",{
        ...
        //Javascript e that is a promise method that applies callback to handle response (synchronous and asynchronous)
      ...
      .then(response =>{
        ...
        //generates an exception and will throw response then try to catch error. If no error then statement executes
        throw response;
      }) 
