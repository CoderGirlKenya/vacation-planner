    ...
    const [touchFoodActivity, setTouchedFoodActivity] = useState (false);
         ...
         const submitHandler = (event) =>  {
            ...
            const clickHandler = (event) => {
              ...
              if (validDestination && validOutdoorsActivity && validToursActivity && validFoodActivity){                     const test =  addVacation(newVacations);                
                    console.log(test);
           ...
           fetch('https://api.jsonbin.io/b/618071784a82881d6c68e66f', options)
                   .then(data => {
                    if (!data.ok) {
            ...
            return (
                <Fragment>
            <form onSubmit={submitHandler} className={classes.backgroundImage}>
