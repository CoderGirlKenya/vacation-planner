  ...
  return (
    <div className={classes.mapContainer}>
      ...
      >
        ...
        {weatherData?.weatherData?.main.length && weatherData.weather.map((data, i) => (
          <div key={i} lat={weatherdata.coord.lat} lng={weather.coord.lon}>
            {/* <img src={`http://openweathermap.org/img/w/${data.weather[0].icon}.png`} alt={`http://openweathermap.org/img/w/${data.weather[0].icon}.png`} height="70px" /> */}
            <h1>weather</h1>
          </div>
        ))}
      </GoogleMapReact>
