    ...
    <div className={classes.mapContainer}>
      ...
      >
        {places.length && places.map((place, i) => (
         ...
         <div>
           {weatherData.weather.length && weatherData.weather.map(weather,i =>{ 
         <img src={`http://openweathermap.org/img/w/${weatherData.weather[i].icon}.png`} alt={`http://openweathermap.org/img/w/${weatherData.weather[i].icon}.png`} height="70px" />
        })}
         </div>
