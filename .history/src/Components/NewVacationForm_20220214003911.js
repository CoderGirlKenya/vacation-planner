...
req.open("PUT", "https://api.jsonbin.io/v3/b/618071784a82881d6c68e66f", true);
req.setRequestHeader("Content-Type", "application/json");
req.setRequestHeader("X-Master-Key", "$2b$10$iujLbiHUNNKEv6DqUG.AG.P90tn1SgbUBMiz8bwDhdAhaZYRcSxy2");
req.send('{"newVacations"}');
